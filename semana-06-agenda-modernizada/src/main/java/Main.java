...
public class Main {
    ...
    private static void agregarContacto() {
        ...
        try {
            ...
            Contacto nuevo = new Contacto(nombre, telefono, email, categoria, direccion);
    ...
    private static void buscarPorNombre() {
        ...
        resultado.ifPresentOrElse(
            c -> System.out.println("Contacto encontrado: " + c),
    ...
    private static void listarTodos() {
        ...
        System.out.println("ID\t| NOMBRE\t\t| TELEFONO\t| CATEGORIA");
        System.out.println("----------------------------------------------------------------");
        
        for (Contacto c : lista) {
            System.out.printf("%s\t| %-20s\t| %s\t| %s\n",
                    c.getId(),
                    c.getNombre().length() > 15 ? c.getNombre().substring(0, 15) : c.getNombre(),
                    c.getTelefono(),
                    c.getCategoria());
        }
    }
